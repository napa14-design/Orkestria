...
const MARCOS = [
  {
    ...
    antes: "O que a operação pediu vivia em ata, planilha e na cabeça de cada supervisor.",
    agora: "Tempo, criticidade, EPIs e calendário viraram regras que o sistema confere sozinho.",
    impacto: "Trocar de supervisor não apaga as regras da sede: elas estão no sistema, não em quem saiu.",
  },
  {
    numero: "02",
  ...
  },
  {
    ...
    antes: "A tela inicial abria com cinco atalhos, indicadores e escolhas antes de o dia começar.",
    agora: "A primeira tela do supervisor — a Central — mostra só o próximo problema e o botão que o resolve.",
    impacto: "Ele cuida de uma coisa por vez, em vez de escolher por onde começar entre dez.",
  },
  {
    numero: "04",
    fase: "Acompanhamento",
    titulo: "O comum virou um toque",
    antes: "Num dia de 40 tarefas, a supervisora abria um formulário para cada uma — até nas 35 que correram normais.",
    agora: "As normais viram um clique em “✓ Conforme”, na própria linha; o formulário completo só nas que fugiram do plano.",
    impacto: "35 formulários viram 35 cliques — e a exceção mantém o cuidado inteiro.",
  },
  {
    numero: "05",
    fase: "Exceção segura",
    titulo: "Resolver deixou de ser um modo",
    antes: "Faltou alguém? Abrir a agenda, achar a tarefa sem dono, procurar um substituto, confirmar.",
    agora: "A Central já sugere pronto — “Maria · 9h30 · confirmar” — quando há um substituto sem conflito.",
    impacto: "Quatro passos viraram um; o sistema revalida a troca antes de gravar, então nunca fura uma regra.",
  },
  {
    numero: "06",
    fase: "Agenda contextual",
    titulo: "Controles aparecem quando servem",
    antes: "A agenda mostrava tudo de uma vez — criar, favoritar, modo foco, atalhos — competindo pela atenção.",
    agora: "Cada botão aparece quando serve e some quando não: dia vazio oferece “gerar o dia”; dia pronto, não.",
    impacto: "A regra do produto: o sistema ganha capacidade por dentro, o supervisor vê menos escolhas por fora.",
  },
] as const;
