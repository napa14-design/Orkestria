...
function seed(): Banco {
  ...
  return {
    ...
    tarefas: [
      ...
      { id: "t2", nome_tarefa: "Higienização de banheiro", tipo_tarefa: "Higienização", local_id: "l2", sede_id: "sede_aldeota", regra_calculo: "por_unidade", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", ativo: true, observacoes: "", ...aud },
      { id: "t3", nome_tarefa: "Higienização de banheiro", tipo_tarefa: "Higienização", local_id: "l3", sede_id: "sede_aldeota", regra_calculo: "por_unidade", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", ativo: true, observacoes: "", ...aud },
      ...
      { id: "t5", nome_tarefa: "Organização de copa", tipo_tarefa: "Organização", local_id: "l5", sede_id: "sede_aldeota", regra_calculo: "fixo", tempo_base_min: 30, quantidade: 1, frequencia: "diaria", prioridade: "media", ativo: true, observacoes: "", ...aud },
      { id: "t6", nome_tarefa: "Limpeza terminal", tipo_tarefa: "Limpeza terminal", local_id: "l6", sede_id: "sede_aldeota", regra_calculo: "por_m2", tempo_base_min: 1.5, quantidade: 1, frequencia: "semanal", prioridade: "baixa", ativo: true, observacoes: "1,5 min/m²", ...aud },
