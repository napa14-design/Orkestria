...
/**
 * Usuários do modo memória — **vazio por padrão**, de propósito.
 *
 * Não existe conta de demonstração com senha conhecida: seria exatamente o tipo
 * de porta que o código de primeiro acesso veio fechar. Para trabalhar em
 * desenvolvimento, declare no `.env` (só tem efeito com `DATA_SOURCE=memory`):
 *
 *     DEV_ADMIN_EMAIL=voce@empresa.com
 *     DEV_ADMIN_SENHA=umaSenhaQualquer
 */
function usuariosSeed(): MapaTabelas["usuarios"][] {
  const email = process.env.DEV_ADMIN_EMAIL?.trim().toLowerCase();
  const senha = process.env.DEV_ADMIN_SENHA;
...
function seed(): Banco {
  const hoje = hojeISO();
  return {
    // Sem usuários de demonstração: contas fictícias com senha conhecida não
    // existem em lugar nenhum. Para usar o modo memória, cadastre um
    // administrador de verdade — ver DEV_ADMIN_EMAIL em `usuariosSeed()`.
    ...
    funcionarios: [
      ...
      { id: "christus_f2", nome: "Naiane", genero: "feminino", sede_id: "christus_dt", turno: "manha", entrada: "07:00", saida: "17:00", intervalo_min: 90, intervalo_inicio: "13:00", intervalo_fim: "14:00", intervalos: "09:00-09:15;13:00-14:00;14:20-14:35", cargo: "ASG", ativo: true, observacoes: "Rota real Christus DT — PEDAGOGIA ED. INF.", ...aud },
      { id: "christus_f3", nome: "Do Vale", genero: "masculino", sede_id: "christus_dt", turno: "manha", entrada: "06:00", saida: "16:00", intervalo_min: 120, intervalo_inicio: "11:00", intervalo_fim: "12:30", intervalos: "09:00-09:15;11:00-12:30;15:00-15:15", cargo: "ASG", ativo: true, observacoes: "Rota real Christus DT — COLETA RESIDUOS", ...aud },
      { id: "christus_f4", nome: "Orlando", genero: "masculino", sede_id: "christus_dt", turno: "manha", entrada: "07:00", saida: "17:00", intervalo_min: 120, intervalo_inicio: "11:30", intervalo_fim: "13:00", intervalos: "09:00-09:15;11:30-13:00;15:00-15:15", cargo: "ASG", ativo: true, observacoes: "Rota real Christus DT — PINTURA", ...aud },
    ],
    locais: [
