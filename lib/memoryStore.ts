...
function seed(): Banco {
  ...
  return {
    ...
    categorias: [
      { id: "c1", nome: "Limpeza concorrente", descricao: "Manutenção do dia a dia (rápida, recorrente).", cor: "#2f6f4f", ativo: true, ...aud },
      { id: "c2", nome: "Higienização", descricao: "Sanitização de banheiros e áreas críticas.", cor: "#9C0D38", ativo: true, ...aud },
      { id: "c3", nome: "Coleta", descricao: "Recolhimento e descarte de resíduos.", cor: "#b8860b", ativo: true, ...aud },
      { id: "c4", nome: "Organização", descricao: "Arrumação e ordenação de ambientes.", cor: "#3a6ea5", ativo: true, ...aud },
      { id: "c5", nome: "Reposição", descricao: "Abastecimento de materiais e insumos.", cor: "#6b4f8a", ativo: true, ...aud },
      { id: "c6", nome: "Limpeza terminal", descricao: "Limpeza profunda/periódica de maior duração.", cor: "#555555", ativo: true, ...aud },
      { id: "c7", nome: "Limpeza externa", descricao: "Áreas externas e fachadas.", cor: "#8a6d3b", ativo: true, ...aud },
    ],
    tarefas: [
      { id: "t1", nome_tarefa: "Limpeza concorrente", tipo_tarefa: "Limpeza concorrente", categoria_id: "c1", local_id: "l1", sede_id: "sede_aldeota", regra_calculo: "por_m2", tempo_base_min: 1, quantidade: 1, frequencia: "diaria", prioridade: "alta", ativo: true, observacoes: "1 min/m²", ...aud },
      { id: "t2", nome_tarefa: "Higienização de banheiro", tipo_tarefa: "Higienização", categoria_id: "c2", local_id: "l2", sede_id: "sede_aldeota", regra_calculo: "por_unidade", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", restricao_genero: "feminino", ativo: true, observacoes: "Banheiro feminino — apenas ASG mulheres", ...aud },
      { id: "t3", nome_tarefa: "Higienização de banheiro", tipo_tarefa: "Higienização", categoria_id: "c2", local_id: "l3", sede_id: "sede_aldeota", regra_calculo: "por_unidade", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", restricao_genero: "masculino", ativo: true, observacoes: "Banheiro masculino — apenas ASG homens", ...aud },
      ...
      { id: "t6", nome_tarefa: "Limpeza terminal", tipo_tarefa: "Limpeza terminal", categoria_id: "c6", local_id: "l6", sede_id: "sede_aldeota", regra_calculo: "por_m2", tempo_base_min: 1.5, quantidade: 1, frequencia: "semanal", prioridade: "baixa", tempo_referencia: true, ativo: true, observacoes: "1,5 min/m² — tempo de referência", ...aud },
      ...
      { id: "t8", nome_tarefa: "Coleta de resíduos", tipo_tarefa: "Coleta", categoria_id: "c3", local_id: "l4", sede_id: "sede_aldeota", regra_calculo: "fixo", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", ativo: true, observacoes: "", ...aud },
      { id: "t12", nome_tarefa: "Limpeza de vidros", tipo_tarefa: "Limpeza terminal", categoria_id: "c6", local_id: "l1", sede_id: "sede_aldeota", regra_calculo: "fixo", tempo_base_min: 40, quantidade: 1, frequencia: "semanal", prioridade: "media", dias_semana: "2,4", ativo: true, observacoes: "Toda terça e quinta", ...aud },
      ...
      { id: "t10", nome_tarefa: "Higienização de banheiro", tipo_tarefa: "Higienização", categoria_id: "c2", local_id: "l8", sede_id: "sede_dt", regra_calculo: "fixo", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", ativo: true, observacoes: "", ...aud },
