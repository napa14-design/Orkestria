...
function seed(): Banco {
  ...
  return {
    ...
    categorias: [
      ...
      { id: "c2", nome: "Higienização", descricao: "Sanitização de banheiros e áreas críticas.", cor: "#9C0D38", fator_intensidade: 1.5, ativo: true, ...aud },
      { id: "c3", nome: "Coleta", descricao: "Recolhimento e descarte de resíduos.", cor: "#b8860b", fator_intensidade: 1, ativo: true, ...aud },
      { id: "c4", nome: "Organização", descricao: "Arrumação e ordenação de ambientes.", cor: "#3a6ea5", fator_intensidade: 0.8, ativo: true, ...aud },
      { id: "c5", nome: "Reposição", descricao: "Abastecimento de materiais e insumos.", cor: "#6b4f8a", fator_intensidade: 0.8, ativo: true, ...aud },
      { id: "c6", nome: "Limpeza terminal", descricao: "Limpeza profunda/periódica de maior duração.", cor: "#555555", fator_intensidade: 1.5, ativo: true, ...aud },
