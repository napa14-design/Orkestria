...
function seed(): Banco {
  ...
  return {
    ...
    tarefas: [
      ...
      { id: "t2", nome_tarefa: "Higienização de banheiro", tipo_tarefa: "Higienização", categoria_id: "c2", local_id: "l2", sede_id: "sede_aldeota", regra_calculo: "por_unidade", tempo_base_min: 20, quantidade: 1, frequencia: "diaria", prioridade: "alta", restricao_genero: "feminino", critica: true, requisitos: "rq1,rq3", ativo: true, observacoes: "Banheiro feminino — apenas ASG mulheres", ...aud },
      ...
      { id: "t12", nome_tarefa: "Limpeza de vidros", tipo_tarefa: "Limpeza terminal", categoria_id: "c6", local_id: "l1", sede_id: "sede_aldeota", regra_calculo: "fixo", tempo_base_min: 40, quantidade: 1, frequencia: "semanal", prioridade: "media", dias_semana: "2,4", requisitos: "rq2", ativo: true, observacoes: "Toda terça e quinta", ...aud },
